...
<head>
  ...
  <!-- Basic TAGS-->
  <title>Patient Review - My PHR</title>
  <!-- Linked Sources -->
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h4>Patient Details
              <a href="patient-data.php" class="btn btn-primary float-end">Add Patient</a>
            </h4>
          </div>
          <div class="card-body">
                    ...
                    foreach($query_run as $patient)
                    {
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="patient-form.php" method="POST" class="d-inline">
